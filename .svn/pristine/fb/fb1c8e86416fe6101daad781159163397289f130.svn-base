 ...
 *
 */
public class Held implements Quelle, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 6282746759415726540L;
	...
	public String toString() {
		return "Held [levelUp=" + levelUp + ", ultimativeEingesetzt=" + ultimativeEingesetzt + ", heldtyp=" + heldtyp
				+ "]";
	}
	...
	public Held klonen() {
		Held klon = new Held();
		klon.setHeldtyp(heldtyp);
		klon.setLevelUp(levelUp);
		klon.setUltimativeEingesetzt(ultimativeEingesetzt);
		return klon;
	}
