...
public class Abenteuer implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6648843890993640653L;
	...
	public Abenteuer klonen() {
		Abenteuer klon = new Abenteuer();
		List<Wuerfel> neueDrachenListe = new ArrayList<>();
		neueDrachenListe.addAll(drachen);
		klon.setDrachen(neueDrachenListe);
		List<Wuerfel> neuerDungeonListe = new ArrayList<>();
		neuerDungeonListe.addAll(dungeon);
		klon.setDungeon(neuerDungeonListe);
		List<Wuerfel> neueGefaehrtenListe = new ArrayList<>();
		neueGefaehrtenListe.addAll(gefaehrten);
		klon.setGefaehrten(neueGefaehrtenListe);
		List<Wuerfel> neueFriedhofListe = new ArrayList<>();
		neueFriedhofListe.addAll(friedhof);
		klon.setFriedhof(neueFriedhofListe);
		klon.setLevel(level);
		klon.setPhase(phase);
